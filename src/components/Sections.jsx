    ...
    <div>
      <section className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            to="/products"
            className="bg-linear-to-r from-green-400 to-green-500 dark:from-green-500 dark:to-green-600 text-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col items-center justify-center text-center font-semibold hover:scale-105 transform"
          >
          ...
          <Link
            to="/sells"
            className="bg-linear-to-r from-blue-400 to-blue-500 dark:from-blue-500 dark:to-blue-600 text-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col items-center justify-center text-center font-semibold hover:scale-105 transform"
          >
